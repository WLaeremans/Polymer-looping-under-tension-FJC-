...
% Error bars
errorbar(log(FF(1:end)), log(TTrc05(1:end)), STDs_log, ...
    "LineStyle", "none", 'Marker', '^', 'LineWidth', 2, ...
    'LineStyle', "none", 'Color', bbpink);
legend('MD simulation', 'theory', '', ...
    'Position', [0.161183560873863 0.775317475627404 0.38560909428516 0.117380954924084], ...
...
% Error bars
errorbar(log(FF(1:end)), log(TTrc1(1:end)), STDs_log, ...
...
% Error bars
errorbar(log(FF(1:end)), log(TTrc1_5(1:end)), STDs_log, ...
    "LineStyle", "none", 'Marker', 'square', 'LineWidth', 2, ...
    'LineStyle', "none", 'Color', bbblue);
legend('MD simulation', 'theory', '', ...
    'Position', [0.161183560873863 0.775317475627404 0.38560909428516 0.117380954924084], ...
    'Interpreter', 'latex', 'FontSize', 14);
hold on;
...
% Legend
lgnd = legend('Sim. $r_c = 0.5$', '', '', ...
    'Sim. $r_c = 1$', '', '', ...
    'Sim. $r_c = 1.5$', 'Theory $\sim N^{3/2}$', ...
